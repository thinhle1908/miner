        ...
        <div class="row">
            ...
            <div class="col-md-6 text-right bounceIn">
                <div class="contact-admin">
                    <a href="{{url('login')}}"><i class="fa fa-user"></i> ĐĂNG KÝ </a>
                    <a href="{{url('register')}}"><i class="fa fa-user-plus"></i> ĐĂNG NHẬP</a>
        ...
        <div class="row">
            ...
            <div class="col-md-9 text-right">
                <ul id="header-menu" class="header-navigation">
                    ...
                    @if(Auth::check())
                        <li>
                            <a href="#">Xin chào. {{ Auth::user()->name }} <i class="fa fa-caret-down"></i></a>
                             <ul class="mega-menu mega-menu1 mega-menu2 menu-postion-4">
                                <li class="mega-list mega-list1"><a href="{{ route('user-dashboard') }}">Bảng Điều Khiển</a>
                               
                                    <a href="{{ route('logout') }}" onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();" class="">Đăng Xuất</a>
                    ...
                    @else
                        <li><a class="page-scroll" href="#">Tài Khoản <i class="fa fa-angle-down"></i></a>
                            <ul class="mega-menu mega-menu1 mega-menu2 menu-postion-4">
                                <li class="mega-list mega-list1">
                                    <a class="page-scroll" href="{{ route('login') }}">Đăng Nhập</a>
                                    <a class="page-scroll" href="{{ route('register') }}">Đăng Ký</a></li>
                            </ul>
                        </li>
                    @endif
                </ul>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="section-header wow zoomInDown" data-wow-duration="2s">
                    <h2>THANH TOÁN <span> ĐƯỢC CHẤP NHẬN</span></h2>
