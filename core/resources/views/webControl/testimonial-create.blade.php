                        ...
                        <div class="row">
                            <div class="col-md-10 col-md-offset-1">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input name="position" class="form-control input-lg" placeholder="Thông tin chi tiết về tác giả" required/>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <textarea name="message" id="area1" rows="5" class="form-control" required placeholder="Tin nhắn chứng thực"></textarea>
                                    </div>
                                </div>
