                    ...
                    <div class="login-admin login-admin1">
                        ...
                        <div class="login-form">     
                            ...
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <input type="text" value="{{ $name }}"  name="name" id="name" required placeholder="Enter your Name"/>
                                    </div>
                                    <div class="col-md-4">
                                        <input type="email" value="{{ $email }}"  name="email" id="email" required placeholder="Enter your Email"/>
                                    </div>
                                    <div class="col-md-4">
