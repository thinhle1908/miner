                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form role="form" method="POST" action="{{url('admin/deposit-method')}}/{{$gateway->id}}" enctype="multipart/form-data">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        @elseif($gateway->id==6)
                                                            <div class="form-group">
                                                                <label for="val1">Skrill ACCOUNT</label>
                                                                <input type="email" value="{{$gateway->val1}}" class="form-control" id="val1" name="val1" >
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="val2">Secret Word</label>
                                                                <input type="text" value="{{$gateway->val2}}" class="form-control" id="val2" name="val2" >
                                                            </div>
                                                        @endif
